...
class CharacterInScene(BaseModel):
    ...
    dynamic_features: Optional[str] = Field(
        default="",
        description="The dynamic features of the character in this specific scene, such as clothing and accessories that may change from scene to scene. If not mentioned or character is not visible, this field can be empty string.",
        examples=[
